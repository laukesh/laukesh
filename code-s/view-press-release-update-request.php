...
<div class="box">
    <div class="box-header with-border">
        <div class="left">
            <h3 class="box-title"><?php echo trans("update_request"); ?></h3>
        </div>
    <?php 
    ...
    <div class="box-body">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="table-responsive">
                    <table class="table table-bordered table-striped dataTable">
                        <?php $this->load->view('admin/press-realease/_filter_request'); ?>
                        <thead>
                        <tr role="row">
                        ...
                        foreach ($view_press_release as $item): ?>
                            <tr>
                                ...
                                <?php 
                                  ...
                                  <a href="<?php echo admin_url(); ?>view_update_request_press_release/<?php echo html_escape($item->id); ?>" title="Approve Update request"><i class="fa fa-edit option-icon"></i></a> 
                                 <?php
                                  }
                                 ?>
                ...
                <h4 class="modal-title">View Press Release Audit History</h4>
                </div>
                <?php if(!empty($item->press_release_id)){?>
                <div class="modal-body">
                <?php 
                $sql = "SELECT * FROM `press_release_history_log` WHERE press_release_id = $item->press_release_id and status != 1 ORDER by updated_at desc";
            ...
            <td>
                ...
                <a  target="_blank" href="<?php echo admin_url(); ?>view-press-release-update-request-display/<?php echo html_escape($value->id); ?>" title="View Press Release"><i class="fa fa-eye option-icon"></i></a>
            </td>
            </tr>
            <?php 
            $i++;
...
<!-- 
<div class="modal fade" id="exampleModalCenter<?php echo $item->press_release_id;?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true"> -->
     <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">View Press Release Audit History<?php echo $item->press_release_id;?></h5>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
            ...
            <a  target="_blank" href="<?php echo admin_url(); ?>view-press-release-update-request-display/<?php echo html_escape($value->id); ?>"><i class="fa fa-eye option-icon"></i></a>
        </td>
      </tr>
       <?php 
        $i++;
