...
<div class="box">
    <div class="box-header with-border">
        <div class="left">
            <h3 class="box-title"><?php echo trans("view_press_release_translate"); ?></h3>
        </div>
    <?php 
     ...
     ?>
        <div class="right">
            <a href="<?php echo admin_url().'add-press-release-translation/'.$this->uri->segment(3); ?>" class="btn btn-success btn-add-new">
                <i class="fa fa-plus"></i>
                <?php echo trans("add_press_release_translation"); ?>
            </a>
        </div> 
        <?php 
                      ...
                      //echo  count($view_press_release);
                        foreach ($view_press_release as $item): ?>
                            ...
                            <tr>
                                ...
                                <td>
                                <?php
                                 if($this->auth_user->role == 'pro_admin' && $this->auth_user->pro_category_id == $pro['0']['id'] && $this->auth_user->permission == 2 && $item->status == 1)
                                 {?>

                                    <a href="<?php echo admin_url(); ?>update-press-release/<?php echo html_escape($item->id); ?>"><i class="fa fa-edit option-icon"></i></a>
                                    <a href="<?php echo admin_url(); ?>view-press-release/<?php echo html_escape($item->id); ?>"><i class="fa fa-eye option-icon"></i></a>
                                ...
                                <?php
                                  ...
                                  <a href="<?php echo admin_url(); ?>update-press-release/<?php echo html_escape($item->id); ?>"><i class="fa fa-edit option-icon"></i></a> 
                                    <a href="<?php echo admin_url(); ?>view-press-release/<?php echo html_escape($item->id); ?>"><i class="fa fa-eye option-icon"></i></a>
                                     <!--  <a href="<?php echo admin_url(); ?>view-press-release/<?php echo html_escape($item->id); ?>"><i class="fa fa-language"></i></a> -->
