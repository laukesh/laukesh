...
function get_video_by_lang(val){
    //alert('heeeeeee');
    var data = {
        "lang_id": val
    };
    ...
    $.ajax({
        type: "POST",
        url: base_url + "gallery_controller/gallery_video_by_lang",
        data: data,
        success: function (response) {
            $('#albums').children('option:not(:first)').remove();
            $("#albums").append(response);
...
function get_audio_by_lang(val){
    var data = {
        "lang_id": val
    };
    data[csfr_token_name] = $.cookie(csfr_cookie_name);
    ...
    $.ajax({
        type: "POST",
        url: base_url + "gallery_controller/gallery_audio_by_lang",
        data: data,
        success: function(response){
            $('#cate_id').children('option:not(:first)').remove();
            $("#cate_id").append(response);
        }
    });
}


function get_pro_cate_by_lang(val) {
    var data = {
        "lang_id": val
    };
    data[csfr_token_name] = $.cookie(csfr_cookie_name);
    ...
    $.ajax({
        type: "POST",
        url: base_url + "press_realease_controller/press_release_cate_by_lang",
        data: data,
        success: function (response) {
            $('#albums').children('option:not(:first)').remove();
            $("#albums").append(response);
...
function get_infographic_by_lang(val) {
    var data = {
        "lang_id": val
    };
    //alert('hi nasir');
    ...
    $.ajax({
        type: "POST",
        url: base_url + "infographic_controller/infographic_by_lang",
        data: data,
        success: function (response) {
            //alert(response);
            $('#infographic_category').children('option:not(:first)').remove();
            $("#infographic_category").append(response);
        }
    });
}

function get_event_by_lang(val) {
    var data = {
        "lang_id": val
    };
    data[csfr_token_name] = $.cookie(csfr_cookie_name);
    ...
    $.ajax({
        type: "POST",
        url: base_url + "event_controller/event_by_lang",
        data: data,
        success: function (response) {
            $('#infographic_category').children('option:not(:first)').remove();
            $("#infographic_category").append(response);
...
function get_categories_by_albums(val) {
    ...
    $.ajax({
        type: "POST",
        url: base_url + "category_controller/video_categories_by_album",
        data: data,
        success: function (response) {
            $('#categories').children('option:not(:first)').remove();
            $("#categories").append(response);
...
function get_categories_by_audio_albums(val) {
    var data = {
        "cate_id": val
    };
    data[csfr_token_name] = $.cookie(csfr_cookie_name);
    ...
    $.ajax({
        type: "POST",
        url: base_url + "category_controller/audio_categories_by_album",
        data: data,
        success: function (response) {
            $('#categories').children('option:not(:first)').remove();
            $("#categories").append(response);
...
$(document).on('change', '#Multifileupload2', function () {
    ...
    if (typeof (FileReader) != "undefined") {
        var MultidvPreview2 = document.getElementById("MultidvPreview2");
        MultidvPreview2.innerHTML = "";
        var regex = /^([a-zA-Z0-9\s_\\.\-:])+(.jpg|.jpeg|.gif|.png|.bmp)$/;
        for (var i = 0; i < MultifileUpload2.files.length; i++) {
            ...
            reader.onload = function (e) {
                ...
                img.src = e.target.result;
                img.id = "Multifileupload_image";
                MultidvPreview2.appendChild(img);
                $("#Multifileupload_button").show();
            }
            reader.readAsDataURL(file);
        }
...
$(document).on('change', '#Multifileupload3', function () {
    var MultifileUpload3 = document.getElementById("Multifileupload3");
    if (typeof (FileReader) != "undefined") {
        var MultidvPreview3 = document.getElementById("MultidvPreview3");
        MultidvPreview3.innerHTML = "";
        var regex = /^([a-zA-Z0-9\s_\\.\-:])+(.mp4)$/;
        for (var i = 0; i < MultifileUpload3.videos.length; i++) {
            var file = MultifileUpload2.files[i];
            var reader = new FileReader();
            reader.onload = function (e) {
                var img = document.createElement("IMG");
                ...
                img.src = e.target.result;
                img.id = "Multifileupload_image";
                MultidvPreview3.appendChild(img);
                $("#Multifileupload_button").show();
            }
            reader.readAsDataURL(file);
        }
