...
/* ankur added comment to test*/
    ...
    */
     ...
     */
      ...
      function generateRandomString33($length = 7) {
    ...
    {
        check_admin();
        $random_number33 = $this->generateRandomString33();
        $data['random_number'] = $random_number33;
    ...
    public function add_user_post()
    {
        ...
        $this->form_validation->set_rules('password', 'Password should be of minimum 8 chars and max 16 chars. It must have atleast 1 uppercase, 1 lowercase 1 number in letters.', 'required|trim');
            ...
            $pass11=explode('.',$decrypted_password);
            $password_decrpt=$pass11[0];
    ...
    {    
        ...
        check_permission('users');
           ...
           echo $password_confirm = $this->input->post('confirm_password');
           die;
            ...
            if($$password_decrpt != $password_confirm_decrpt){
        ...
        if ($this->form_validation->run() === false) {
            ...
            if($this->input->post('password') == $this->input->post('confirm_password')){
             ...
             if($this->auth_model->change_password($id)){           
                $this->session->set_flashdata('success', trans("msg_updated_pass"));
                redirect($this->agent->referrer());
