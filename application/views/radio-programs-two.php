...
<div class="col-md-12">
 ...
 <nav aria-label="breadcrumb">
  <ol class="breadcrumb breadcrumb_text">
    ...
    <li class="breadcrumb-item active" aria-current="page"><?php echo $tran_lang['radio_programs'];?></li>
  </ol>
</nav>
</div>
</div>
...
<!-- <div class="col-md-2">
<a href="<?php echo base_url('audio-list');?>" type="button" class="archived1"><?php echo $tran_lang['archives'];?></a>
</div> -->
  </form>
...
<div class="row mb-2 mt-3">
 <div class="col-md-12"><h1 class="media-heading"><?php echo $tran_lang['radio_programs'];?><br><span class="media-heading-sub"><a href="<?php echo base_url('audio-list');?>"><?php echo $tran_lang['fifteen_days_radio_programms'];?>" </a></span></h1></div>
