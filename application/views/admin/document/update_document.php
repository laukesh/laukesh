    ...
    <div class="col-md-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title"><?php //echo trans('update_category'); ?>Update Document</h3>
            </div>
            <!-- /.box-header -->

            <!-- form start -->
            <?php echo form_open_multipart('document_controller/update_document_post'); ?>
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                 <div class="form-group">
                              ...
                              <label for="file-upload">document file <small>(document PDF Files)</small></label>
                    <input type="file" id="file-upload" accept=".doc, .docx, .ppt, .pdf" name ="file" class="form-control" >
                               <div id="file-upload-filename"></div>

                                </div> 
                                 <a href="<?php echo base_url().$category->path;?>" target="_blank"><small>View document File</small></a>
                </div>
            </div>
            </div>
