...
<div class="row">
    <div class="col-lg-5 col-md-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title"><?php //echo trans("add_category"); ?>Add Sainik Samachar Category</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <?php echo form_open('SainikPratika_controller/add_category_post'); ?>
    ...
    <div class="col-lg-7 col-md-12">
        <div class="box">
            <div class="box-header with-border">
                <div class="pull-left">
                    <h3 class="box-title"><?php //echo trans('categories'); ?>View Sainik Samachar Categories</h3>
                </div>
            </div><!-- /.box-header -->
                            ...
                            <table class="table table-bordered table-striped dataTable" id="cs_datatable_lang" role="grid"
                                ...
                                foreach ($categories as $item){ ?>
                                    <tr>
                                        ...
                                        <td><?php echo html_escape($item->visibility); ?></td>
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu options-dropdown">
                                                    <li>
                                                        <a href="<?php echo admin_url(); ?>update-sainik-samachar-category/<?php echo html_escape($item->id); ?>"><i class="fa fa-edit option-icon"></i><?php echo trans('edit'); ?></a>
                                                    </li>
                                                    <li>
                                                        <a href="javascript:void(0)" onclick="delete_item('SainikPratika_controller/delete_category_post','<?php echo $item->id; ?>','<?php echo trans("confirm_category"); ?>');"><i class="fa fa-trash option-icon"></i><?php echo trans('delete'); ?></a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </td>
