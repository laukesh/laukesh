...
<div class="row">
    <div class="col-lg-4 col-md-12">
        <div class="box box-primary">
            ...
            <!-- form start -->
            <?php echo form_open('infographic_controller/add_infographic_category_post'); ?>
    ...
    <div class="col-lg-8 col-md-12">
        <div class="box">
            <div class="box-header with-border">
                <div class="pull-left">
                    <h3 class="box-title"><?php //echo trans('gallery_albums'); ?>Infographic Category</h3>
                </div>
            </div><!-- /.box-header -->
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu options-dropdown">
                                                    <li>
                                                        <a href="<?php echo admin_url(); ?>update-infographic-category/<?php echo html_escape($item->id); ?>"><i class="fa fa-edit option-icon"></i><?php echo trans('edit'); ?></a>
                                                    </li>
                                                    <li>
                                                        <a href="javascript:void(0)" onclick="delete_item('infographic_controller/delete_infographic_category_post','<?php echo $item->id; ?>','<?php echo trans("confirm_album"); ?>');"><i class="fa fa-trash option-icon"></i><?php echo trans('delete'); ?></a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </td>
