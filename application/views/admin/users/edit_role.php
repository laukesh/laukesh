        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-1 col-sm-2 col-xs-2">
                            <input type="checkbox" name="sainik_patrika" value="1" id="role_widgets" class="square-purple" <?php echo ($role->sainik_patrika == 1) ? 'checked' : ''; ?>>
                        </div>
                        <div class="col-md-11 col-sm-10 col-xs-10">
                            <label for="role_widgets" class="control-label cursor-pointer"><?php echo "Sainik Patrika"; ?></label>
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-1 col-sm-2 col-xs-2">
                            <input type="checkbox" name="press_release" value="1" id="role_widgets" class="square-purple" <?php echo ($role->press_release == 1) ? 'checked' : ''; ?>>
                        </div>
                        <div class="col-md-11 col-sm-10 col-xs-10">
                            <label for="role_widgets" class="control-label cursor-pointer"><?php echo "Press Release"; ?></label>
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-1 col-sm-2 col-xs-2">
                            <input type="checkbox" name="gallery" value="1" id="role_widgets" class="square-purple" <?php echo ($role->gallery == 1) ? 'checked' : ''; ?>>
                        </div>
                        <div class="col-md-11 col-sm-10 col-xs-10">
                            <label for="role_widgets" class="control-label cursor-pointer"><?php echo "Photo/Video Gallery"; ?></label>
                        </div>
                    </div>
                </div>
                <div class="form-group">
