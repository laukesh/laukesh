                            ...
                            <tr>
                                ...
                                <td style="height: 50px;">
                                    ...
                                    <?php else: ?>
                                        ...
                                        <?php endif; ?>
                                        <?php if ($role->sainik_patrika == 1): ?>
                                            <label class="label label-default"><?php echo "Sainik Patrika"; ?></label>
                                        <?php endif; ?>
                                        <?php if ($role->press_release == 1): ?>
                                            <label class="label label-default"><?php echo "Press Release" ?></label>
                                        <?php endif; ?>
                                        <?php if ($role->gallery == 1): ?>
                                            <label class="label label-default"><?php echo "Photo / Video Gallery"; ?></label>
                                        <?php endif; ?>
