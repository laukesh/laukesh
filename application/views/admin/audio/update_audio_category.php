    ...
    <div class="col-lg-5 col-md-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title"><?php //echo trans('update_category'); ?>Update Radio Program Category</h3>
            </div>
            <!-- /.box-header -->

            <!-- form start -->
            <?php echo form_open('category_controller/update_audio_category_post'); ?>
                ...
                <div class="form-group">
                    ...
                    <select name="album_id" id="albums" class="form-control" required>
                        ...
                        <?php foreach ($albums as $album): ?>
                            <option value="<?php echo $album->id; ?>" <?php echo ($category->audio_album_id == $album->id) ? 'selected' : ''; ?>><?php echo $album->name; ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
                <div class="form-group">
            ...
            <div class="box-footer">
                <button type="submit" class="btn btn-primary pull-right"><?php //echo trans('save_changes'); ?>Update Radio Program Category</button>
            </div>
            <!-- /.box-footer -->
