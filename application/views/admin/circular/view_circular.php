...
<div class="box">
    <div class="box-header with-border">
        <div class="left">
            <h3 class="box-title"><?php //echo trans("video"); ?>View Circular</h3>
        </div>
        <div class="right">
                    ...
                    <div class="col-sm-12">
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped">
                                <?php $this->load->view('admin/circular/_filter'); ?>
                                <thead>
                                <tr role="row">
                                    ...
                                    <th><?php //echo trans('album'); ?>Circular Number</th>
                                ...
                                <?php foreach ($categories as $item): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php $album = get_circular_category($item->category_id);
                                            if (!empty($album)) {
                                                echo html_escape($album->name);
                                            } ?>
                                        </td>
                                       <td><?php echo html_escape($item->circular_number); ?></td>
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu options-dropdown">
                                                    <li>
                                                        <a href="<?php echo admin_url(); ?>update-circular-manage/<?php echo html_escape($item->id); ?>"><i class="fa fa-edit option-icon"></i><?php echo trans('edit'); ?></a>
                                                    </li>
                                                    <li>
                                                        <a href="javascript:void(0)" onclick="delete_item('circular_controller/delete_circular_category_post','<?php echo $item->id; ?>','<?php echo trans("confirm_category"); ?>');"><i class="fa fa-trash option-icon"></i><?php echo trans('delete'); ?></a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </td>
