...
$pro = $this -> db
           ...
           ->result_array();
//echo $view_press_release[0]->status;
//echo $view_press_release[0]->status_withdraw;
//die();
?>
    ...
    <div class="col-sm-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <div class="left">
                    <h3 class="box-title"><?php echo trans("update_press_release_withdraw_request"); ?></h3>
                </div>
                 <?php 
             ...
             <div class="form-group">
              ...
              <?php }else  if($this->auth_user->role == 'hq admin' && $this->auth_user->pro_category_id = $pro['0']['id'] && $this->auth_user->permission = 2)
                ...
                <?php 
                     ...
                     if($view_press_release[0]->status_withdraw == 1){?>
                    
                      <div class="col-md-2 col-sm-2 col-xs-12 col-option">
                            <input type="radio" id="rb_is_active_2" name="status" value="7" onclick="hideDiv()" <?php if($view_press_release[0]->status == '3' && $view_press_release[0]->status_withdraw == '1'){ echo "checked=checked";}  ?>>
                            <label for="rb_is_active_2" class="cursor-pointer"><?php echo trans('withdraw'); ?></label>
                        </div>

                  <div class="col-md-2 col-sm-2 col-xs-12 col-option">
                            <input type="radio" id="rb_is_active_2" name="status" value="3" onclick="hideDiv()" <?php if($view_press_release[0]->status == 3 && $view_press_release[0]->status_withdraw == 0){ echo "checked=checked";}  ?>>
                            <label for="rb_is_active_2" class="cursor-pointer"><?php echo trans('publish'); ?></label>
                        </div>
