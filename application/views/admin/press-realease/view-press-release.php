    ...
    <div class="col-sm-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <div class="left">
                    <?php if(!empty($view_press_release[0]->status == 4)){?>
                    <h3 class="box-title"><?php echo trans("view_press_release_schedule"); ?></h3>
                <?php 
                 }else{?>
        ...
        <div class="form-group" id="brief_des" <?php if($view_press_release[0]->event_subject !== 'Press Release'){ echo 'style="display:none"';}?>>
            ...
            <textarea class="tinyMCE form-control"
                           ...
                           value=""><?php echo $view_press_release[0]->press_release_text;?></textarea>
    </div>  
...
<div class="col-sm-8">
<input type="text" name="caption-image-text[]" class="form-control"  disabled="disabled" value="<?php echo html_escape($value->caption); ?>" placeholder="Brief Description"></div>
</div>
<?php 
}
?>
...
$(function() {
    $('#event_subject').change(function(){
        if($('#event_subject').val() == 'Press Release') {
            $('#brief_des').show();  
        } else {
             $('#brief_des').hide(); 
