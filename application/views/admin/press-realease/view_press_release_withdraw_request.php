                        ...
                        foreach ($view_press_release as $item): ?>
                            ...
                            <tr>
                               ...
                               <td>
                                ...
                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#message<?php echo $item->press_release_id;?>" title="Press Release History">Audit History</button>
           
                                <?php 
                                  if($this->auth_user->role == 'admin' || $this->auth_user->role == 'hq admin'){?>
                                  <a href="<?php echo admin_url(); ?>view-press-realease-withdraw-request/<?php echo html_escape($item->id); ?>" title="Approve Withdrawl Request"><i class="fa fa-edit option-icon"></i></a> 
                                 <?php
                                  }
                                 ?>
