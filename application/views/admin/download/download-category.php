...
<div class="row">
    <div class="col-lg-4 col-md-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title"><?php //echo trans("add_album"); ?>Add download Category</h3>
            </div>
            <!-- /.box-header -->

            <!-- form start -->
            <?php echo form_open('download_controller/add_download_category_post'); ?>
            ...
            <div class="box-footer">
                <button type="submit" class="btn btn-primary pull-right"><?php echo trans('add-download-category'); ?></button>
            </div>
            <!-- /.box-footer -->
    ...
    <div class="col-lg-8 col-md-12">
        <div class="box">
            <div class="box-header with-border">
                <div class="pull-left">
                    <h3 class="box-title"><?php echo trans('view_download_category'); ?></h3>
                </div>
            </div><!-- /.box-header -->
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu options-dropdown">
                                                    <li>
                                                        <a href="<?php echo admin_url(); ?>update-download-category/<?php echo html_escape($item->id); ?>"><i class="fa fa-edit option-icon"></i><?php echo trans('edit'); ?></a>
                                                    </li>
                                                    <li>
                                                        <a href="javascript:void(0)" onclick="delete_item('download_controller/delete_gallery_album_post','<?php echo $item->id; ?>','<?php echo trans("confirm_album"); ?>');"><i class="fa fa-trash option-icon"></i><?php echo trans('delete'); ?></a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </td>
