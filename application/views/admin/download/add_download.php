    ...
    <div class="col-md-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title"><?php //echo trans('add_category'); ?>Add Downdoad</h3>
            </div>
            <!-- /.box-header -->

            <!-- form start -->
            <?php echo form_open_multipart('download_controller/add_download_manage_post'); ?>
        ...
        <div class="row">
            ...
            <!-- <div class="col-sm-4">
                 <div class="form-group">
                    <label><?php echo trans('download_number'); ?></label>
                    <input type="number" class="form-control" name="download_number" placeholder="<?php echo trans('download_number'); ?>"
                           value="<?php echo old('download_number'); ?>" maxlength="200" <?php echo ($this->rtl == true) ? 'dir="rtl"' : ''; ?> >
                  </div>
               </div> -->
            </div>
             <div class="row">
            ...
            <div class="box-footer">
                <button type="submit" class="btn btn-primary pull-right"><?php //echo trans('add_category'); ?>Add Download</button>
            </div>
            <?php echo form_close(); ?>
        </div>
    </div>
