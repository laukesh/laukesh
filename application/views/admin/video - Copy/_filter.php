...
<div class="row table-filter-container">
    <div class="col-sm-12">
        <?php echo form_open(admin_url() . 'video', ['method' => 'GET']); ?>
        ...
        <div class="item-table-filter">
            ...
            <select name="lang_id" class="form-control" onchange="get_audio_albums_by_lang(this.value);">
        ...
        <div class="item-table-filter">
            ...
            <select id="albums" name="cate_id" class="form-control" onchange="get_categories_by_albums(this.value);">
                <option value=""><?php echo trans("all"); ?></option>
            ...
            <div class="form-group">
                ...
                <select id="categories" name="sub_cate_id" class="form-control">
                    ...
                    if (!empty($this->input->get('album', true))):
                        $categories = $this->gallery_category_model->get_categories_by_video_album($this->input->get('album', true));
                        if (!empty($categories)) {
