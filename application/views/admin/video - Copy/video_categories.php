...
<div class="row">
    <div class="col-lg-4 col-md-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title"><?php //echo trans('add_category'); ?>Add Video Sub Category</h3>
            </div>
            <!-- /.box-header -->

            <!-- form start -->
            <?php echo form_open('category_controller/add_video_category_post'); ?>
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    <label><?php //echo trans("Category"); ?>Category</label>
    ...
    <div class="col-lg-8 col-md-12">
        <div class="box">
            <div class="box-header with-border">
                <div class="pull-left">
                    <h3 class="box-title"><?php //echo trans('gallery_categories'); ?>Video Sub Categories</h3>
                </div>
            </div><!-- /.box-header -->
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped dataTable" id="cs_datatable_lang" role="grid"
                                ...
                                <tr role="row">
                                    ...
                                    <th><?php //echo trans('category_name'); ?>Audio Category</th>
                                    <th><?php //echo trans('album'); ?>Video Album</th>
                                ...
                                <?php foreach ($categories as $item): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php $album = get_video_album($item->cate_id);
                                            if (!empty($album)){
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu options-dropdown">
                                                    <li>
                                                        <a href="<?php echo admin_url(); ?>update-video-category/<?php echo html_escape($item->id); ?>"><i class="fa fa-edit option-icon"></i><?php echo trans('edit'); ?></a>
                                                    </li>
                                                    <li>
