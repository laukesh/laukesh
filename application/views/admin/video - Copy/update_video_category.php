    ...
    <div class="col-lg-5 col-md-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title"><?php //echo trans('update_category'); ?>Update Audio Category</h3>
            </div>
            <!-- /.box-header -->

            <!-- form start -->
            <?php echo form_open('category_controller/update_video_category_post'); ?>
                ...
                <div class="form-group">
                    ...
                    <select name="album_id" id="albums" class="form-control" required>
                        ...
                        <?php foreach ($video_albums as $album): ?>
                            <option value="<?php echo $album->id; ?>" <?php echo ($category->cate_id == $album->id) ? 'selected' : ''; ?>><?php echo $album->name; ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
                <div class="form-group">
