...
<!-- <div class="col-md-2">
<a href="<?php //echo base_url('video-list');?>" type="button" class="archived1"><?php echo $tran_lang['archives'];?></a>
</div> -->
  </form>
</div>
</div>
<div class="row mb-2 mt-3">
 <div class="col-md-12"><h1 class="media-heading"><?php echo $tran_lang['videos'];?><br><span class="media-heading-sub"><a href="<?php echo base_url('video-list');?>"><?php echo $tran_lang['fifteen_days_videos'];?></a></span></h1></div>
