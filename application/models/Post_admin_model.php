...
class Post_admin_model extends CI_Model
{
    ...
    {
       $pro_category_id = $this->auth_user->pro_category_id;
        $role = $this->auth_user->role;
        $user_id = $this->auth_user->id;

        if($pro_category_id == 0 && $role == 'admin' || 'hd admin'){

        $sql = "SELECT COUNT(id) AS count FROM press_release WHERE  is_active = 1";
        ...
        else if($role == 'pro admin' && $user_id !=0 ){
            $sql = "SELECT COUNT(id) AS count FROM press_release WHERE  is_active = 1 and pro_category = '$user_id'";
        $query = $this->db->query($sql);
        }
    ...
    public function get_pending_posts_count()
    {
       $pro_category_id = $this->auth_user->pro_category_id;
        ...
        $sql = "SELECT COUNT(id) AS count FROM press_release WHERE status = 2 AND is_active = 1";
        $query = $this->db->query($sql);
        // if (!check_user_permission('manage_all_posts')) {
        //     $sql = "SELECT COUNT(id) AS count FROM posts WHERE status = 1 AND is_scheduled = 1 AND user_id = ?";
        //     $query = $this->db->query($sql, array(clean_number($this->auth_user->id)));
        // }
            ...
            $sql = "SELECT COUNT(id) AS count FROM press_release WHERE status = 2 AND is_active = 1 and pro_category = '$user_id'";
        $query = $this->db->query($sql);
        }
        return $query->row()->count;
    }
    ...
    public function get_drafts_count()
    {
        ...
        $sql = "SELECT COUNT(id) AS count FROM press_release WHERE status = 1 AND is_active = 1";
        $query = $this->db->query($sql);
        // if (!check_user_permission('manage_all_posts')) {
        //     $sql = "SELECT COUNT(id) AS count FROM posts WHERE status = 1 AND is_scheduled = 1 AND user_id = ?";
        //     $query = $this->db->query($sql, array(clean_number($this->auth_user->id)));
        // }
            ...
            $sql = "SELECT COUNT(id) AS count FROM press_release WHERE status = 1 AND is_active = 1 and pro_category = '$user_id'";
        $query = $this->db->query($sql);
        }
        return $query->row()->count;;
    }
    ...
    public function get_scheduled_posts_count()
    {
        ...
        $sql = "SELECT COUNT(id) AS count FROM press_release WHERE status = 4 AND is_active = 1";
        $query = $this->db->query($sql);
        // if (!check_user_permission('manage_all_posts')) {
        //     $sql = "SELECT COUNT(id) AS count FROM posts WHERE status = 1 AND is_scheduled = 1 AND user_id = ?";
        //     $query = $this->db->query($sql, array(clean_number($this->auth_user->id)));
        // }
            ...
            $sql = "SELECT COUNT(id) AS count FROM press_release WHERE status = 4 AND is_active = 1 and pro_category = '$user_id'";
        $query = $this->db->query($sql);
        }
        return $query->row()->count;
    }
