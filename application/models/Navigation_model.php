...
class Navigation_model extends CI_Model
{
    ...
    public function get_menu_links($lang_id)
    {
        ...
        AS item_type, pages.link AS item_link, pages.parent_id AS item_parent_id, pages.visibility AS item_visibility FROM pages WHERE pages.lang_id = ?)) AS menu_items ORDER BY item_id";
