...
class Settings_model extends CI_Model
{
    ...
    public function get_settings_two()
    {
    ...
    public function get_social_media_fb_settings()
    {   $id = 1;
        $sql = "SELECT * FROM tbl_facebook WHERE id =  ?";
        $query = $this->db->query($sql, array(clean_number($id)));
        return $query->row();
    }
    public function get_social_media_link_settings()
    {   $id = 1;
        $sql = "SELECT * FROM tbl_linkedin WHERE id =  ?";
        $query = $this->db->query($sql, array(clean_number($id)));
        return $query->row();
    }
    ...
    public function get_social_media_insta_settings()
    {   $id = 1;
        $sql = "SELECT * FROM tbl_instagram WHERE id =  ?";
        $query = $this->db->query($sql, array(clean_number($id)));
        return $query->row();
    }
